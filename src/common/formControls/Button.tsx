  ...
  return (
    <div className="flex w-full">
      <button type={type} onClick={onClick} {...rest} disabled={isBusy}
        className={cx("inline-flex justify-center w-full px-8 py-2 mt-2 font-semibold transition duration-500 ease-in-out transform rounded-sm shadow-xl focus:ring focus:outline-none",
        ...
        {isBusy ? <><svg className="w-5 h-5 mr-3 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
