                                ...
                                <div className={cx("flex", openTab === 1 ? "block" : "hidden")} id="link1">
                                    ...
                                    <div className="w-3/4">
                                        {profileSideBar === 1 && <div>
                                            {isProfilePhotoEditing ?
                                                ...
                                                <div>
                                                    <img
                                                        className="mx-auto shadow-lg h-44"
                                        ...
                                        {profileSideBar === 2 && <div>Details</div>}
                                        {profileSideBar === 3 && <div>Email</div>}
                                        {profileSideBar === 4 && <div>Username</div>}
                                    ...
                                    <div className="w-1/4 px-4 py-2 text-gray-700 border-l-2 border-gray-100">
                                        <ul>
                                            ...
                                            <li onClick={() => setProfileSideBar(3)} className={cx("profile-side-bar", profileSideBar === 3 && "profile-side-bar-active")}>Email</li>
                                            <li onClick={() => setProfileSideBar(4)} className={cx("profile-side-bar", profileSideBar === 4 && "profile-side-bar-active")}>Username</li>
                                        </ul>
